...
- action_matches_intent is false AND semantic_distance > 0.4 for destructive actions.
...
### MODIFY
Return MODIFY ONLY for write_file actions where the target path is unsafe:
